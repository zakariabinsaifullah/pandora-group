...
export default function Library({
    ...
    return (
        <Modal
            overlayClassName="pandora-modal__overlay"
            className={`pandora-modal is-${activeTab}`}
            title={__('Icons Library', 'pandora-group')}
            onRequestClose={onClose}
            isFullScreen={true}
            headerActions={<Header activeTab={activeTab} onTabChange={onTabChange} />}
        >
            <div className="pandora-modal__container">
                <Sidebar
                ...
                />
                <div className="pandora-modal__content">
